...
{
	public class MegaHellephantHealth : MonoBehaviour
	{
		...
		public void TakeDamage (int amount, Vector3 hitPoint)
		{
			...
			healthSlider.SetSlider (currentHealth);
			...
			if(currentHealth <= 0)
			{
				// ... the enemy is dead.
				Death ();
				healthSlider.SetInactive();
				healthSlider.SetSlider(healthSlider.slider.maxValue);
			}
		}
